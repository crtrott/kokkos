...
FUNCTION(KOKKOS_SET_LIBRARY_PROPERTIES LIBRARY_NAME)
  ...
  TARGET_COMPILE_OPTIONS(
    ${LIBRARY_NAME} PUBLIC
    $<$<COMPILE_LANGUAGE:${KOKKOS_CMAKE_COMPILE_LANGUAGE}>:${KOKKOS_COMPILE_OPTIONS}>
  )

  TARGET_COMPILE_DEFINITIONS(
    ${LIBRARY_NAME} PUBLIC
    $<$<COMPILE_LANGUAGE:${KOKKOS_CMAKE_COMPILE_LANGUAGE}>:${KOKKOS_COMPILE_DEFINITIONS}>
  )
  ...
  IF (KOKKOS_ENABLE_CUDA)
    TARGET_COMPILE_OPTIONS(
      ${LIBRARY_NAME}
      PUBLIC $<$<COMPILE_LANGUAGE:${KOKKOS_CMAKE_COMPILE_LANGUAGE}>:${KOKKOS_CUDA_OPTIONS}>
    )
    ...
    TARGET_COMPILE_OPTIONS(
      ${LIBRARY_NAME}
      PUBLIC $<$<COMPILE_LANGUAGE:${KOKKOS_CMAKE_COMPILE_LANGUAGE}>:${NODEDUP_CUDAFE_OPTIONS}>
    )
  ENDIF()
  ...
  IF (KOKKOS_ENABLE_HIP)
    TARGET_COMPILE_OPTIONS(
      ${LIBRARY_NAME}
      PUBLIC $<$<COMPILE_LANGUAGE:${KOKKOS_CMAKE_COMPILE_LANGUAGE}>:${KOKKOS_AMDGPU_OPTIONS}>
    )
  ENDIF()
  ...
  IF(KOKKOS_XCOMPILER_OPTIONS)
    ...
    TARGET_COMPILE_OPTIONS(
      ${LIBRARY_NAME}
      PUBLIC $<$<COMPILE_LANGUAGE:${KOKKOS_CMAKE_COMPILE_LANGUAGE}>:${NODEDUP_XCOMPILER_OPTIONS}>
    )
  ENDIF()
