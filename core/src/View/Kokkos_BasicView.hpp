...
#endif
#ifndef KOKKOS_BASICVIEW_HPP
#define KOKKOS_BASICVIEW_HPP
...
template <class DataType, class... Properties>
class BasicView : public ViewTraits<DataType, Properties...> {
 private:
  template <class, class...>
 ...
 protected:
  using view_tracker_type = Kokkos::Impl::ViewTracker<BasicView>;
  using map_type =
 ...
 public:
  ...
  using array_type =
      BasicView<typename traits::scalar_array_type,
  ...
  using const_type =
      BasicView<typename traits::const_data_type, typename traits::array_layout,
                typename traits::device_type, typename traits::hooks_policy,
                typename traits::memory_traits>;

  /** \brief  Compatible view of non-const data type */
  using non_const_type =
      BasicView<typename traits::non_const_data_type,
                typename traits::array_layout, typename traits::device_type,
                typename traits::hooks_policy, typename traits::memory_traits>;
  ...
  /** \brief  Compatible HostMirror view */
  using host_mirror_type = BasicView<
...
#undef KOKKOS_IMPL_VIEW_OPERATOR_VERIFY
  ...
  KOKKOS_FUNCTION
  BasicView& operator=(BasicView&& other) {
  ...
  KOKKOS_INLINE_FUNCTION BasicView(
      ...
      std::enable_if_t<Kokkos::Impl::ViewMapping<
          traits, typename BasicView<RT, RP...>::traits,
          typename traits::specialize>::is_assignable_data_type>* = nullptr)
      : m_track(rhs), m_map() {
    using SrcTraits = typename BasicView<RT, RP...>::traits;
  ...
  KOKKOS_INLINE_FUNCTION std::enable_if_t<
      ...
      BasicView>&
  operator=(const BasicView<RT, RP...>& rhs) {
    using SrcTraits = typename BasicView<RT, RP...>::traits;
    using Mapping   = Kokkos::Impl::ViewMapping<traits, SrcTraits,
                                              typename traits::specialize>;
  ...
  KOKKOS_INLINE_FUNCTION BasicView(const BasicView<RT, RP...>& src_view,
                                   const Arg0 arg0, Args... args)
      : m_track(src_view), m_map() {
    using SrcType = BasicView<RT, RP...>;
 ...
 public:
  ...
  template <class... P>
  explicit KOKKOS_INLINE_FUNCTION BasicView(
      const Impl::ViewCtorProp<P...>& arg_prop,
      std::enable_if_t<Impl::ViewCtorProp<P...>::has_pointer,
                       typename traits::array_layout> const& arg_layout)
  ...
  explicit inline BasicView(
      ...
      : BasicView(arg_prop, typename traits::array_layout(
  ...
  explicit inline BasicView(
      ...
      const size_t arg_N7 = KOKKOS_IMPL_CTOR_DEFAULT_ARG)
      : BasicView(
            Impl::ViewCtorProp<std::string>(arg_label),
  ...
  explicit KOKKOS_INLINE_FUNCTION BasicView(
      ...
      const size_t arg_N7 = KOKKOS_IMPL_CTOR_DEFAULT_ARG)
      : BasicView(
            Impl::ViewCtorProp<pointer_type>(arg_ptr),
            typename traits::array_layout(arg_N0, arg_N1, arg_N2, arg_N3,
                                          arg_N4, arg_N5, arg_N6, arg_N7)) {
    static_assert(traits::array_layout::is_extent_constructible,
                  "Layout is not constructible from extent arguments. Use "
  ...
  shmem_size(const size_t arg_N0 = KOKKOS_INVALID_INDEX,
    ...
    return BasicView::shmem_size(typename traits::array_layout(
        arg_N0, arg_N1, arg_N2, arg_N3, arg_N4, arg_N5, arg_N6, arg_N7));
  }
 ...
 public:
  ...
  explicit KOKKOS_INLINE_FUNCTION BasicView(
      ...
      : BasicView(
            Impl::ViewCtorProp<pointer_type>(reinterpret_cast<pointer_type>(
  ...
  KOKKOS_INLINE_FUNCTION
    ...
    (__cpp_conditional_explicit >= 201806L)
      ...
      explicit(!std::is_convertible_v<
               ...
               typename Impl::MDSpanViewTraits<traits>::mdspan_type>)
#endif
          BasicView(const Kokkos::mdspan<ElementType, ExtentsType, LayoutType,
                                         AccessorType>& mds)
      : BasicView(typename Impl::MDSpanViewTraits<traits>::mdspan_type(mds)) {
  }
...
KOKKOS_INLINE_FUNCTION auto subview(const BasicView<D, P...>& src,
                                    Args... args) {
  static_assert(BasicView<D, P...>::rank == sizeof...(Args),
...
#endif /* #ifndef KOKKOS_BASICVIEW_HPP */
